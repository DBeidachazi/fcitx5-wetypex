...
version='0.1.0';archive=output/f'fcitx5-wetypex-{version}.tar.gz'
files=[]
for name in ['CMakeLists.txt','README.md','LICENSE','NOTICE','CHANGELOG.md','CONTRIBUTING.md','SECURITY.md','.dockerignore','.editorconfig','.gitattributes','.gitignore','src','data','scripts','tools','packaging','docs']:
    p=root/name
